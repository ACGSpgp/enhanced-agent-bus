...
from enhanced_agent_bus._compat.security.jwt_algorithms import (
...
try:
    SESSION_JWT_ALGORITHM = resolve_jwt_algorithm(
        os.environ.get("SESSION_JWT_ALGORITHM"),
        error_code="SESSION_JWT_ALGORITHM_INVALID",
        setting_name="SESSION_JWT_ALGORITHM",
    )
except Exception as exc:
    raise ValueError(
        f"Unsupported JWT_ALGORITHM={os.environ.get('SESSION_JWT_ALGORITHM', 'RS256')!r}. "
        f"Allowed: {sorted(ALLOWED_JWT_ALGORITHMS)}"
    ) from exc
