...
RedisAwaitableT = TypeVar("RedisAwaitableT")


async def _await_maybe(value: RedisAwaitableT | Any) -> RedisAwaitableT | Any:
    """Await Redis operations that may appear sync or async to static typing."""
...
class RedisPubSubProtocol(Protocol):
    """Subset of pubsub API used by the voting system."""
...
class RedisClientProtocol(Protocol):
    """Subset of Redis client API used by deliberation persistence."""

    def ping(self) -> object: ...
    async def close(self) -> object: ...
    async def xadd(self, key: str, fields: JSONDict) -> object: ...
    async def hset(self, key: str, field: str, value: str) -> object: ...
    async def hget(self, key: str, field: str) -> str | None: ...
    async def hdel(self, key: str, field: str) -> object: ...
    async def hgetall(self, key: str) -> dict[str, str]: ...
    async def xinfo_stream(self, key: str) -> JSONDict: ...
...
class RedisVotingSystem:
    ...
    def __init__(self, redis_url: str = "redis://localhost:6379") -> None:
        ...
        self._pubsub: RedisPubSubProtocol | None = None
    ...
    async def get_votes_pubsub_instance(self, item_id: str) -> RedisPubSubProtocol | None:
        """
