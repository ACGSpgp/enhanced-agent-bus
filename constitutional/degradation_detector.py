...
try:
    ...
    from scipy import stats as _stats_module
...
class DegradationDetector:
    ...
    def _chi_square_test(
        ...
        try:
            np_module = np
            stats_module = stats
            if np_module is None or stats_module is None:
                return None

            # Create contingency table
            observed = np_module.array(
                [
            ...
            chi2, p_value, dof, _expected = stats_module.chi2_contingency(observed)
