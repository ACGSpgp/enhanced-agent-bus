...
def get_workflow_executor(request: Request) -> DurableWorkflowExecutor:
    ...
    return cast(DurableWorkflowExecutor, executor)


def get_agent_bus(request: Request) -> MessageProcessor | dict[str, Any]:
    ...
    return cast(MessageProcessor | dict[str, Any], bus)
...
def get_batch_processor(request: Request) -> BatchMessageProcessor:
    ...
    return cast(BatchMessageProcessor, processor)
