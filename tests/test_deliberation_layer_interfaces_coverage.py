...
class TestOPAGuardProtocol:
    ...
    async def test_verify_action_returns_guard_result(self):
        from enhanced_agent_bus.deliberation_layer.opa_guard import GuardResult
    ...
    async def test_collect_signatures(self):
        from enhanced_agent_bus.deliberation_layer.opa_guard import SignatureResult
    ...
    async def test_submit_for_review(self):
        from enhanced_agent_bus.deliberation_layer.opa_guard import ReviewResult
