...
class RedisPipelineProtocol(Protocol):
    """Subset of Redis pipeline API used by the pool."""
...
class RedisClientProtocol(Protocol):
    """Subset of Redis client API used by the pool."""
...
class RedisConnectionPoolProtocol(Protocol):
    """Subset of Redis connection pool API used by the pool wrapper."""
...
class RedisConnectionPool:
    ...
    def __init__(
        ...
        self._pool: RedisConnectionPoolProtocol | None = None
        self._redis: RedisClientProtocol | None = None
    ...
    @asynccontextmanager
    async def acquire(self) -> AsyncIterator[RedisClientProtocol]:
        """
