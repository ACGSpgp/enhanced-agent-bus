...
class RateLimitExceededWrapper(StubRateLimitExceeded):
    ...
    def __init__(
        ...
        super().__init__(agent_id, message, retry_after_ms)
...
def stub_create_correlation_middleware() -> Callable[..., object] | None:
