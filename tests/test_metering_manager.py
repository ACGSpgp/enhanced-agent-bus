...
class TestRecordValidationResult:
    ...
    def test_record_validation_result_success(
        ...
        mock_metering_hooks.on_constitutional_validation.assert_called_once()
        call_args = mock_metering_hooks.on_constitutional_validation.call_args
        assert call_args.kwargs["tenant_id"] == "test-tenant"
    ...
    def test_record_validation_result_exception_handled(
        ...
        mock_metering_hooks.on_constitutional_validation.side_effect = Exception("Error")
...
class TestMeteringManagerIntegration:
    ...
    async def test_full_lifecycle(
        ...
        assert mock_metering_hooks.on_constitutional_validation.call_count == 1
    ...
    async def test_fire_and_forget_pattern(
        ...
        mock_metering_hooks.on_constitutional_validation.side_effect = Exception("Service down")
