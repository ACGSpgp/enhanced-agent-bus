...
async def _collect_stats_payload(
    bus: MessageProcessor | _MetricsProvider | dict[str, object] | None = None,
) -> JSONDict:
...
async def get_stats(
    ...
    bus: MessageProcessor | dict[str, object] = Depends(get_agent_bus),
) -> JSONDict:
