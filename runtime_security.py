...
def _load_attr(module_name: str, attr_name: str) -> Any | None:
    """Best-effort optional import helper for standalone/fallback mode."""
    try:
...
validate_constitutional_hash = cast(
    Callable[[str], Any] | None,
    _load_attr(".validators", "validate_constitutional_hash"),
)
validate_payload_integrity = cast(
    Callable[[object], Any] | None,
    _load_attr(".validators", "validate_payload_integrity"),
)
get_constitutional_classifier = cast(
    Callable[[], Any] | None,
    _load_attr(".constitutional_classifier", "get_constitutional_classifier"),
)
...
class RuntimeSecurityScanner:
    ...
    async def _check_constitutional_hash(
        ...
        if validate_constitutional_hash is None:
            raise RuntimeError("Constitutional hash validator not available")
    ...
    def _get_or_create_guardrails(self) -> Any:
