...
if TYPE_CHECKING:
    from enhanced_agent_bus._compat.types import AgentIdentity, AgentInfo, JSONDict
else:
    try:
        from enhanced_agent_bus._compat.types import AgentIdentity, AgentInfo, JSONDict
    except ImportError:
        ...
        AgentIdentity: TypeAlias = dict[str, Any]
...
class _MACIRegistryProtocol(Protocol):
    async def register_agent(self, agent_id: str, role: object) -> object: ...
...
class RegistryManager:
    ...
    def __init__(
        ...
        maci_registry: _MACIRegistryProtocol | None = None,
    ...
    async def register_agent(
        ...
        **kwargs: object,
        ...
        normalized_auth_token = auth_token if isinstance(auth_token, str) else None
    ...
    def _store_local_agent(
        ...
        role_value = getattr(maci_role, "value", None)
        if isinstance(role_value, str):
            normalized_role = role_value
        elif isinstance(maci_role, str):
            normalized_role = maci_role
        else:
    ...
    async def unregister_agent(self, aid: str) -> bool:
        ...
        res: bool | object = self._registry.unregister(aid)
        ...
        *,
        ...
        if isinstance(identity_override, dict):
            for key in (
                ...
                value = identity_override.get(key)
