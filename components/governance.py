...
try:
    from ..adaptive_governance import (
        initialize_adaptive_governance as _initialize_adaptive_governance_fn,
    )
    from ..adaptive_governance import provide_governance_feedback as _provide_governance_feedback_fn

    ADAPTIVE_GOVERNANCE_AVAILABLE = True
except ImportError:
    ADAPTIVE_GOVERNANCE_AVAILABLE = False
    _initialize_adaptive_governance_fn = None  # type: ignore[assignment]
    _provide_governance_feedback_fn = None  # type: ignore[assignment]

initialize_adaptive_governance: Any | None = _initialize_adaptive_governance_fn
provide_governance_feedback: Any | None = _provide_governance_feedback_fn
...
class GovernanceValidator:
    ...
    def __init__(
        ...
        self._adaptive_governance: AdaptiveGovernanceEngine | None = None
        self._metrics_ref: Any | None = None  # Set by BusCore if needed, or passed in calls
    ...
    async def initialize(self) -> None:
        ...
        if self._enable_adaptive_governance:
            try:
                if initialize_adaptive_governance is None:
                    raise RuntimeError("Adaptive governance initializer unavailable")
    ...
    async def shutdown(self) -> None:
        ...
        if self._adaptive_governance is not None:
            try:
    ...
    def provide_feedback(self, msg: AgentMessage, success: bool) -> None:
        ...
        if self._adaptive_governance and hasattr(self._adaptive_governance, "decision_history"):
            ...
            if recent_decisions:
                ...
                if ADAPTIVE_GOVERNANCE_AVAILABLE and provide_governance_feedback is not None:
