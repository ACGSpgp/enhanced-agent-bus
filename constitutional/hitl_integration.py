...
class ConstitutionalHITLIntegration:
    ...
    def _init_approval_chains(self) -> None:
    ...
    async def create_approval_request(
        ...
        try:
            ...
            if not isinstance(request_id_value, str) or not request_id_value:
                raise ValueError("HITL service response missing request_id")
    ...
    async def check_approval_status(self, request_id: str) -> JSONDict | None:
        ...
        try:
            ...
            status_data = cast(JSONDict, response.json())
            logger.info(
    ...
    def _determine_approval_chain(self, proposal: AmendmentProposal) -> ApprovalChainConfig:
        ...
        if impact_score >= 0.8:
            ...
            return self.high_impact_chain
        elif impact_score >= 0.5:
            # Medium impact - standard chain
            return self.medium_impact_chain
        else:
            # Low impact - single approver
            return self.low_impact_chain
...
**Constitutional Hash:** {CONSTITUTIONAL_HASH}
    ...
    async def _send_notifications(
        ...
        channels = approval_request.chain_config.notification_channels or []
