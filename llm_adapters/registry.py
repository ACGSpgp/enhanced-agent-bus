...
if TYPE_CHECKING:
    from src.core.shared import metrics as _shared_metrics
    ...
    try:
        ...
        from enhanced_agent_bus._compat import metrics as _shared_metrics
...
class LLMAdapterRegistry:
        ...
        **kwargs: object,
        ...
        for adapter_id in adapters:
            ...
            try:
                ...
                # Wrap in circuit breaker — use default arg to capture bound_adapter (B023)
                async def _complete(_adp: Any = bound_adapter) -> LLMResponse:
                    return cast(LLMResponse, await _adp.acomplete(messages, **cast(Any, kwargs)))

                response = cast(LLMResponse, await breaker.call(_complete))
    ...
    async def __aenter__(self) -> "LLMAdapterRegistry":
