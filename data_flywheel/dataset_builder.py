...
class DatasetSnapshotBuilder:
    ...
    async def build_snapshot(
        ...
        *,
        ...
        all_events: list[DecisionEvent | FeedbackEvent] = [*decisions, *feedback]
    ...
    def _assert_dataset_isolation(
        ...
        *,
        ...
        all_events: list[DecisionEvent | FeedbackEvent] = [*decision_events, *feedback_events]
    ...
    def _build_records(
        ...
        for feedback_event in sorted(feedback_events, key=lambda item: item.created_at):
            redacted = redact_for_dataset_export(feedback_event.model_dump(mode="json"))
            if contains_unredacted_pii(redacted):
