...
CompiledPatternSet: TypeAlias = list[tuple[re.Pattern[str], InjectionType, InjectionSeverity]]
DetectedTypeSet: TypeAlias = set[InjectionType]
...
class PromptInjectionDetector:
    ...
    def _scan_pattern_set(
        ...
        detected_types: DetectedTypeSet,
    ...
    def _resolve_primary_type(self, detected_types: DetectedTypeSet) -> InjectionType | None:
    ...
    def detect(self, content: object, context: JSONDict | None = None) -> InjectionDetectionResult:
        ...
        matched_patterns: list[str] = []
        detected_types: DetectedTypeSet = set()
        max_severity = None
