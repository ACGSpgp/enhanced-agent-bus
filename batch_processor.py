...
_batch_processor_instance: BatchMessageProcessor | None = None
...
def get_batch_processor() -> "BatchMessageProcessor":
    ...
    if _batch_processor_instance is None:
        try:
            ...
            _batch_processor_instance = BatchMessageProcessor(message_processor=MessageProcessor())
...
class BatchMessageProcessor:
    ...
    def __init__(self, **kwargs: object) -> None:
        ...
        self._message_processor: MessageProcessorProtocol | None = (
            cast("MessageProcessorProtocol", _message_processor)
        ...
        self._custom_validator: Callable[[BatchRequestItem], tuple[bool, JSONDict]] | None = (
            cast(Callable[[BatchRequestItem], tuple[bool, JSONDict]], _validator)
            ...
            if self._custom_validator:
                try:
                    ...
                    return ValidationResult(
                        ...
                        decision=str(result_dict) if is_valid else None,
                        errors=(
