...
class OpenClawAdapter(BaseLLMAdapter):
    ...
    MODEL_PRICING: ClassVar[dict[str, dict[str, float]]] = {
        ...
        "openai/gpt-5.5": {"prompt": 2.00, "completion": 16.00},
    ...
    def _get_client(self) -> _OpenAIClientProtocol:
        ...
        if self._client is None:
            ...
            self._client = cast(
                ...
                openai.OpenAI(**cast(Any, client_kwargs)),
            )
    ...
    async def _get_async_client(self) -> _AsyncOpenAIClientProtocol:
        ...
        if self._async_client is None:
            ...
            self._async_client = cast(
                ...
                openai.AsyncOpenAI(**cast(Any, client_kwargs)),
            )
    ...
    def complete(
        ...
        **kwargs: object,
        ...
        try:
            ...
            llm_response = ResponseConverter.from_openai_response(raw, provider="openclaw")
            llm_response.metadata.model = self.model
            return llm_response
