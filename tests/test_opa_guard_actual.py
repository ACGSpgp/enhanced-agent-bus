...
# Import model types from opa_guard (not opa_guard_models) to guarantee
# the same class instance as the runtime — avoids duplicate-module enum
# identity failures under pytest --import-mode=importlib.
try:
