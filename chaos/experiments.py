...
class ChaosExperiment:
    ...
    def __init__(
        ...
        self._aborted = False
        self._validation_task: asyncio.Task[object] | None = None
    ...
    async def _await_scenario_completion(
        self,
        scenario_task: asyncio.Task[ScenarioResult],
        scenario_results: list[ScenarioResult],
        observations: list[str],
    ) -> None:
    ...
    def _create_experiment_result(
        ...
        self._result = ExperimentResult(
            ...
            ended_at=ended_at,
            duration_s=(ended_at - (self._started_at or ended_at)).total_seconds(),
...
def chaos_experiment(
    hypothesis: str,
    scenario: BaseScenario,
    steady_state_metrics: dict[str, tuple[str, float]] | None = None,
    abort_on_violation: bool = False,
) -> Callable[[F], F]:
    """
