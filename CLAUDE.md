...
├── governance/           # Democratic deliberation + capability passports (ADR-018)
│   ├── capability_passport.py   # CapabilityPassport, PassportRegistry, DomainAutonomy
│   ├── governance_proposal.py   # GovernanceProposal state machine
│   ├── loop_orchestrator.py     # SuggestedRule → Polis → proposal lifecycle
│   ├── democratic_governance.py # DemocraticConstitutionalGovernance
│   └── polis_engine.py          # Polis deliberation engine
