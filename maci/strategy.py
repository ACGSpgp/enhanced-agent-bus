...
class _SessionContextLike(Protocol):
    session_id: str | None
...
class AgentMessage(Protocol):
    ...
    to_agent: str | None
    session_id: str | None
    session_context: _SessionContextLike | None
...
def create_maci_enforcement_middleware(
    ...
    [AgentMessage, Callable[[AgentMessage], Awaitable[AgentMessage]]],
    ...
    async def middleware(
        msg: AgentMessage, next_handler: Callable[[AgentMessage], Awaitable[AgentMessage]]
    ) -> AgentMessage:
