...
class ConstitutionalSagaWorkflow:
    ...
    def __init__(
        ...
        self._steps: list[SagaStep[object]] = []
    ...
    def add_step(self, step: SagaStep[object]) -> "ConstitutionalSagaWorkflow":
        """Add a step to the saga. Returns self for chaining."""
        self._steps.append(step)
        return self

    async def _save_current_state(self, context: SagaContext) -> None:
    ...
    async def _execute_step(self, step: SagaStep[object], context: SagaContext) -> bool:
    ...
    async def _run_compensations(self, context: SagaContext) -> None:
...
def _add_capacity_reservation_step(
    saga: ConstitutionalSagaWorkflow,
...
def _add_compliance_validation_step(
    saga: ConstitutionalSagaWorkflow,
    acts: DefaultSagaActivities,
) -> None:
...
def _add_policy_application_step(
    saga: ConstitutionalSagaWorkflow,
    acts: DefaultSagaActivities,
) -> None:
