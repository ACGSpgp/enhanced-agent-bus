...
class _CheckpointPersistenceProtocol(Protocol):
...
class ConstitutionalCheckpointManager:
    ...
    def __init__(
        self,
        persistence: _CheckpointPersistenceProtocol | None = None,
    ...
    async def list_checkpoints(
        ...
        """
        if self.persistence:
            return await self.persistence.list_checkpoints(workflow_id, run_id)
