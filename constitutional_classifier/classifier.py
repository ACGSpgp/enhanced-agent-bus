...
if TYPE_CHECKING:
    from ..maci.enforcer import MACIEnforcer
    from ..maci.models import MACIValidationResult
...
class ConstitutionalClassifierV2:
    ...
    async def _validate_maci(
        ...
        try:
            ...
            from ..maci.models import MACIAction
    ...
    def test_jailbreak_patterns(self, test_prompts: list[str]) -> _JailbreakTestResults:
        ...
        for prompt in test_prompts:
            ...
            detail = {
                ...
                "detected_pattern": (
                    ...
                    if match is not None and match.pattern is not None
                    else None
                ),
...
def get_constitutional_classifier_v2(
    ...
    **kwargs: Any,
    ...
    if _global_classifier is None or config is not None:
        _global_classifier = ConstitutionalClassifierV2(config=config, **cast(Any, kwargs))
