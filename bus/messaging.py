...
class MessageHandler:
    ...
    async def broadcast_message(
        self,
        msg: AgentMessage,
        send_message_func: Callable[[AgentMessage], Awaitable[ValidationResult]],
        ...
        """
        normalized_tenant_id = normalize_tenant_id(msg.tenant_id)
        if normalized_tenant_id is not None:
            msg.tenant_id = normalized_tenant_id
