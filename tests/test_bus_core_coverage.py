...
class TestModuleLevelConstants:
    ...
    def test_maci_enforcer_protocol_importable(self) -> None:
        # MACIEnforcer/MACIRoleRegistry were removed as module-level names in favour
        # of MACIEnforcerProtocol.  Verify the protocol can be imported from maci.
        from enhanced_agent_bus.maci import MACIEnforcer, MACIRoleRegistry  # noqa: F401
