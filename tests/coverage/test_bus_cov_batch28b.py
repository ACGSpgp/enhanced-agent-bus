...
class TestConfigureTelemetryOtelAvailable:
    ...
    def test_configure_telemetry_first_time_otel_available(self):
        ...
        with (
            ...
            patch("enhanced_agent_bus.observability.telemetry._trace_api", mock_trace),
            patch("enhanced_agent_bus.observability.telemetry._metrics_api", mock_metrics),
...
class TestGetTracerOtelAvailable:
    ...
    def test_get_tracer_auto_configures(self):
        ...
        with (
            ...
            patch("enhanced_agent_bus.observability.telemetry._tracers", {}),
            patch(
                "enhanced_agent_bus.observability.telemetry._trace_api",
    ...
    def test_get_tracer_creates_new_when_not_cached(self):
        ...
        with (
            ...
            patch("enhanced_agent_bus.observability.telemetry._trace_api", mock_trace_mod),
        ):
...
class TestGetMeterOtelAvailable:
    ...
    def test_get_meter_auto_configures(self):
        ...
        with (
            ...
            patch("enhanced_agent_bus.observability.telemetry._meters", {}),
            patch(
                "enhanced_agent_bus.observability.telemetry._metrics_api",
    ...
    def test_get_meter_creates_new_when_not_cached(self):
        ...
        with (
            ...
            patch("enhanced_agent_bus.observability.telemetry._metrics_api", mock_metrics_mod),
        ):
...
class TestSetupTelemetryProviders:
    ...
    def test_setup_telemetry_providers_full(self):
        ...
        with (
            ...
            patch(
                "enhanced_agent_bus.observability.telemetry._resource_cls",
                mock_resource_cls,
            ),
            patch(
...
class TestConfigureTraceProviderPaths:
    ...
    def test_configure_trace_provider_export_with_otlp(self):
        ...
        with (
            patch(
                "enhanced_agent_bus.observability.telemetry._tracer_provider_cls",
                return_value=mock_tp,
            ),
            patch(
                "enhanced_agent_bus.observability.telemetry._batch_span_processor_cls",
    ...
    def test_configure_trace_provider_simple_processor(self):
        ...
        with (
            ...
            patch(
                "enhanced_agent_bus.observability.telemetry._simple_span_processor_cls",
...
class TestConfigureMeterProviderPaths:
    ...
    def test_configure_meter_provider_export_success(self):
        ...
        with (
            patch(
                "enhanced_agent_bus.observability.telemetry._meter_provider_cls",
                return_value=mock_mp,
            ),
            patch(
                "enhanced_agent_bus.observability.telemetry._periodic_metric_reader_cls",
...
class TestConfigurePropagation:
    ...
    def test_configure_propagation_success(self):
        ...
        with (
            ...
            patch("enhanced_agent_bus.observability.telemetry._set_global_textmap") as mock_set,
        ):
