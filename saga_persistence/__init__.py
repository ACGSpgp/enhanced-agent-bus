...
if TYPE_CHECKING:
    ...
    try:
        ...
        PostgresSagaStateRepository = None
        SCHEMA_SQL = ""
...
if TYPE_CHECKING:
    ...
    try:
        ...
        RedisSagaStateRepository = None
        SAGA_STATE_PREFIX: str = "saga:state:"
        SAGA_CHECKPOINT_PREFIX: str = "saga:checkpoint:"
        SAGA_COMPENSATION_PREFIX: str = "saga:compensation:"
        SAGA_LOCK_PREFIX: str = "saga:lock:"
        SAGA_INDEX_STATE_PREFIX: str = "saga:idx:state:"
        SAGA_INDEX_TENANT_PREFIX: str = "saga:idx:tenant:"
        DEFAULT_TTL_DAYS = 30
