...
if TYPE_CHECKING:
    ...
    try:
        ...
        create_decision_explanation = None
...
class DecisionStore:
    ...
    def _require_pool(self) -> RedisConnectionPool:
    ...
    async def get(
        ...
        try:
            ...
            if self._use_memory_fallback:
                ...
                async with self._require_pool().acquire() as conn:
                    json_data = cast(str | None, await conn.get(key))
    ...
    async def get_by_message_id(
        ...
        try:
            ...
            if self._use_memory_fallback:
                ...
                async with self._require_pool().acquire() as conn:
                    decision_id = cast(str | None, await conn.get(msg_key))
