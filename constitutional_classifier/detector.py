...
class ThreatDetector:
    ...
    def __init__(
        ...
        self._on_threat_detected: list[Callable[..., object]] = []
        self._on_block: list[Callable[..., object]] = []
    ...
    async def _standard_detect(
        self, content: str, context: dict[str, Any] | None, start_time: float
    ) -> DetectionResult:
    ...
    def on_threat_detected(self, callback: Callable[..., object]) -> None:
        """Register callback for threat detection events."""
        self._on_threat_detected.append(callback)

    def on_block(self, callback: Callable[..., object]) -> None:
